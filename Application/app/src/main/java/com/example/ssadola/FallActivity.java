...
public class FallActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager mLinearLayoutManager = new LinearLayoutManager(FallActivity.this);
        mLinearLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        rv = findViewById(R.id.recyclerview_fall);
        rv.setHasFixedSize(true);
        rv.setLayoutManager(mLinearLayoutManager);

        SeasonFestival information = new SeasonFestival();
        information.execute("가을");
    ...
    class SeasonFestival extends AsyncTask<String,Void,String>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            loading = ProgressDialog.show(FallActivity.this, "Please Wait", null, true, true);
        }
        @Override
    ...
    public void getImgfromURL(final String[] img_link){
        ...
        try {
            mThread.join();
            RecyclerAdapterSeason adapter = new RecyclerAdapterSeason(FallActivity.this,arrayList,bitmap,R.layout.activity_fall,TAG_SEASON);
            Log.e("onCreate[arrayList]", "" + arrayList.size());
            rv.setAdapter(adapter);
