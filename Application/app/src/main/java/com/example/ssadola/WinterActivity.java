...
public class WinterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager mLinearLayoutManager = new LinearLayoutManager(WinterActivity.this);
        mLinearLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        rv = findViewById(R.id.recyclerview_winter);
        rv.setHasFixedSize(true);
        rv.setLayoutManager(mLinearLayoutManager);

        SeasonFestival information = new SeasonFestival();
        information.execute("겨울");
    ...
    class SeasonFestival extends AsyncTask<String,Void,String>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            loading = ProgressDialog.show(WinterActivity.this, "Please Wait", null, true, true);
        }
        @Override
