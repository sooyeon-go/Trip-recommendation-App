...
public class SummerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager mLinearLayoutManager = new LinearLayoutManager(SummerActivity.this);
        mLinearLayoutManager.setOrientation(LinearLayoutManager.VERTICAL);
        rv = findViewById(R.id.recyclerview_summer);
        rv.setHasFixedSize(true);
        rv.setLayoutManager(mLinearLayoutManager);

        SeasonFestival information = new SeasonFestival();
        information.execute("여름");
    ...
    class SeasonFestival extends AsyncTask<String,Void,String>{
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            loading = ProgressDialog.show(SummerActivity.this, "Please Wait", null, true, true);
        }
        @Override
